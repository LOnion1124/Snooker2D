...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{imgs/english_panel.png}
\caption{加塞控制面板}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{imgs/language_switch.png}
\caption{设置面板与双语切换}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{imgs/test_results.png}
\caption{单元测试运行结果}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{imgs/commit_hist_1.png}\\
\vspace{0.3cm}
\includegraphics[width=0.85\textwidth]{imgs/commit_hist_2.png}\\
\vspace{0.3cm}
\includegraphics[width=0.85\textwidth]{imgs/commit_hist_3.png}
\caption{Git 提交历史}
\end{figure}
